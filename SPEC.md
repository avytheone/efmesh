...
```
физический слой:  efmesh__med__stays__a3f9c1            ← таблица по fingerprint
                  lake/med/stays/fp=a3f9c1/…/*.parquet  ← или parquet-партиции (§3.3)
виртуальный слой: dev.med.stays  → view → физика a3f9c1
                  prod.med.stays → view → физика 88b2e0
```
...
Физическая таблица: `efmesh__<schema>__<name>__<fp8>` в служебной схеме движка,
где `fp8` — первые 8 символов fingerprint.
